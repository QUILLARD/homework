...
from bboard.views import BbCreateView, BbView, BbByRubricView, BbDetailView, BbDayArchiveView
...
urlpatterns = [
    ...
    path('<int:year>/<int:month>/<int:day>/', BbDayArchiveView.as_view(), name="archive_day"),
]
